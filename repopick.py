...
if __name__ == '__main__':
    ...
    default_gerrit = 'https://android-review.googlesource.com/'

    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
        repopick.py is a utility to simplify the process of cherry picking
        patches from AOSP Gerrit instance (or any gerrit instance of your choosing)
    ...
    for item in mergables:
        ...
        if 'http' in item['fetch']:
            method = 'http'
        elif 'anonymous http' in item['fetch']:
