...
cd $rdir/packages/providers/TelephonyProvider && git fetch slimroms && git merge slimroms/lp5.0 && git push https://github.com/ezio84/packages_providers_TelephonyProvider lp5.0
# The end
